<?php
/**
   * Blucube_SWSTATS_Spyc -- A Simple PHP YAML Class
   * @version 0.6.2
...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return Blucube_SWSTATS_Spyc::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_load_file')) {
  ...
  function spyc_load_file ($file) {
    return Blucube_SWSTATS_Spyc::YAMLLoad($file);
  }
}
...
if (!function_exists('spyc_dump')) {
  ...
  function spyc_dump ($data) {
    return Blucube_SWSTATS_Spyc::YAMLDump($data, false, false, true);
  }
}

if (!class_exists('Blucube_SWSTATS_Spyc')) {
...
/**
   ...
   * Usage:
   * <code>
   *   $Spyc  = new Blucube_SWSTATS_Spyc;
   *   $array = $Spyc->load($file);
   * </code>
   * or:
   * <code>
   *   $array = Blucube_SWSTATS_Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
...
/**
 * Load a valid YAML string to Blucube_SWSTATS_Spyc.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to Blucube_SWSTATS_Spyc.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Blucube_SWSTATS_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Blucube_SWSTATS_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
...
// Enable use of Blucube_SWSTATS_Spyc from command line
// The syntax is the following: php Blucube_SWSTATS_Spyc.php spyc.yaml

do {
  if (PHP_SAPI != 'cli') break;
  if (empty ($_SERVER['argc']) || $_SERVER['argc'] < 2) break;
  if (empty ($_SERVER['PHP_SELF']) || FALSE === strpos ($_SERVER['PHP_SELF'], 'Blucube_SWSTATS_Spyc.php') ) break;
  $file = $argv[1];
